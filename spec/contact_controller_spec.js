...
describe("ContactController", () => {
   ...
   describe("#addContact()", () => {
    ...
    it("should add a single contact into the book", (done) => {
        this.book.addContact("Alice", "001-101-1010") // We call addContact on book, and it returns a promise. When resolved, we execute the callback where we set our expectations. When we successfully POST to the database, the ORM returns the object it just persisted so we can confirm it was successful.
        .then((contact) => {
